...
/**
 * FlightAirlineContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FlightAirlineContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightAirlineContract';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FlightAirlineContract., must be bigger than or equal to 1.');
        }
     ...
     * Sets iata
     *
     * @param string|null $iata IATA code of the airline
     *
     * @return self
     */
     ...
     * Sets icao
     *
     * @param string|null $icao ICAO code of the airline
     *
     * @return self
     */
