...
/**
 * AirportDistanceTimeContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AirportDistanceTimeContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirportDistanceTimeContract';
    ...
    protected static $openAPITypes = [
        'from' => '\OpenAPI\Client\Model\ListingAirportContract',
        'to' => '\OpenAPI\Client\Model\ListingAirportContract',
        'great_circle_distance' => '\OpenAPI\Client\Model\Distance',
        'approx_flight_time' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'approx_flight_time' => 'approxFlightTime'
    ];
    ...
    protected static $setters = [
        ...
        'approx_flight_time' => 'setApproxFlightTime'
    ];
    ...
    protected static $getters = [
        ...
        'approx_flight_time' => 'getApproxFlightTime'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('approx_flight_time', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['great_circle_distance'] === null) {
            $invalidProperties[] = "'great_circle_distance' can't be null";
        }
        if ($this->container['approx_flight_time'] === null) {
            $invalidProperties[] = "'approx_flight_time' can't be null";
        }
     ...
     * Sets from
     *
     * @param \OpenAPI\Client\Model\ListingAirportContract $from Airport information
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\Model\ListingAirportContract $to Airport information
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\Distance $great_circle_distance Great circle distance measured directly between origin and destination
     *
     * @return self
     */
    public function setGreatCircleDistance($great_circle_distance)
    {
        if (is_null($great_circle_distance)) {
            throw new \InvalidArgumentException('non-nullable great_circle_distance cannot be null');
        }
    ...
    /**
     * Gets approx_flight_time
     *
     * @return string
     */
    public function getApproxFlightTime()
    {
        return $this->container['approx_flight_time'];
    }

    /**
     * Sets approx_flight_time
     *
     * @param string $approx_flight_time Approximate flight time based on re-calculation of great circle distance  against statistical duration average of multiple flights covered similar  distance before.
     *
     * @return self
     */
    public function setApproxFlightTime($approx_flight_time)
    {
        if (is_null($approx_flight_time)) {
            throw new \InvalidArgumentException('non-nullable approx_flight_time cannot be null');
        }
        $this->container['approx_flight_time'] = $approx_flight_time;
