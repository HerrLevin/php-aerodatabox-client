...
/**
 * FlightNotificationContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FlightNotificationContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightNotificationContract';
    ...
    protected static $openAPITypes = [
        'flights' => '\OpenAPI\Client\Model\FlightNotificationItemContract[]',
        'subscription' => '\OpenAPI\Client\Model\SubscriptionContract'
    ];
    ...
    */
     ...
     * Gets flights
     *
     * @return \OpenAPI\Client\Model\FlightNotificationItemContract[]|null
     */
     ...
     * Sets flights
     *
     * @param \OpenAPI\Client\Model\FlightNotificationItemContract[]|null $flights Modified/created flight notification
     *
     * @return self
     */
    ...
    {
        if (is_null($flights)) {
            array_push($this->openAPINullablesSetToNull, 'flights');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('flights', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets subscription
     *
     * @return \OpenAPI\Client\Model\SubscriptionContract|null
     */
     ...
     * Sets subscription
     *
     * @param \OpenAPI\Client\Model\SubscriptionContract|null $subscription Related subscription
     *
     * @return self
     */
