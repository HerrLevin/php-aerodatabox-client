...
/**
 * StringAircraftContractSearchResultCollectionContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StringAircraftContractSearchResultCollectionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringAircraftContractSearchResultCollectionContract';
    ...
    */
    ...
    public function setSearchBy($search_by)
    {
        ...
        if ((mb_strlen($search_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $search_by when calling StringAircraftContractSearchResultCollectionContract., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringAircraftContractSearchResultCollectionContract., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringAircraftContractSearchResultCollectionContract., must be bigger than or equal to 0.');
        }
