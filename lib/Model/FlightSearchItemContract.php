...
/**
 * FlightSearchItemContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FlightSearchItemContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightSearchItemContract';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Found flight number.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling FlightSearchItemContract., must be bigger than or equal to 1.');
        }
