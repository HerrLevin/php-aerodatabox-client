...
/**
 * FaaLaddAircraftStatusContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FaaLaddAircraftStatusContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FaaLaddAircraftStatusContract';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id ID of the aircraft / flight checked (callsign or aircraft tail number).  Trimmed, without hyphens.
     *
     * @return self
     */
     ...
     * Sets is_blocked
     *
     * @param bool $is_blocked Current status of the aircraft / flight in the FAA LADD industry list.
     *
     * @return self
     */
