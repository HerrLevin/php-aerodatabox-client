...
/**
 * FeedServiceStatusContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FeedServiceStatusContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedServiceStatusContract';
    ...
    protected static $openAPITypes = [
        'service' => '\OpenAPI\Client\Model\FeedServiceEnum',
        'status' => '\OpenAPI\Client\Model\FeedServiceStatus',
        'min_available_local_date' => '\DateTime',
        'max_available_local_date' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        'service' => null,
        'status' => null,
        'min_available_local_date' => 'date-time',
        'max_available_local_date' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        'service' => false,
        'status' => false,
        'min_available_local_date' => true,
        'max_available_local_date' => true
    ];
    ...
    protected static $attributeMap = [
        'service' => 'service',
        'status' => 'status',
        'min_available_local_date' => 'minAvailableLocalDate',
        'max_available_local_date' => 'maxAvailableLocalDate'
    ];
    ...
    protected static $setters = [
        'service' => 'setService',
        'status' => 'setStatus',
        'min_available_local_date' => 'setMinAvailableLocalDate',
        'max_available_local_date' => 'setMaxAvailableLocalDate'
    ];
    ...
    protected static $getters = [
        'service' => 'getService',
        'status' => 'getStatus',
        'min_available_local_date' => 'getMinAvailableLocalDate',
        'max_available_local_date' => 'getMaxAvailableLocalDate'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('min_available_local_date', $data ?? [], null);
        $this->setIfExists('max_available_local_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets service
     *
     * @return \OpenAPI\Client\Model\FeedServiceEnum
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\FeedServiceStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\FeedServiceStatus $status Status of the service<p>Possible values:</p> <ul> <li><b>0 - Down</b>: Service is provided, but is currently down</li> <li><b>1 - Degraded</b>: Service is up and running, but performance is degraded: delays and disruptions are likely</li> <li><b>2 - OKPartial</b>: Service is up and running normally, but updates vailable for not all or only few flights</li> <li><b>3 - OK</b>: Service is up and running normally</li> <li><b>-2 - Unknown</b>: Status of service is unknown</li> <li><b>-1 - Unavailable</b>: Service is not provided</li> </ul>
     *
     * @return self
     */
    ...
    /**
     * Gets min_available_local_date
     *
     * @return \DateTime|null
     * @deprecated
     */
    public function getMinAvailableLocalDate()
    {
        return $this->container['min_available_local_date'];
    }

    /**
     * Sets min_available_local_date
     *
     * @param \DateTime|null $min_available_local_date Date of the oldest flight stored (based on scheduled local times)
     *
     * @return self
     * @deprecated
     */
    public function setMinAvailableLocalDate($min_available_local_date)
    {
        if (is_null($min_available_local_date)) {
            array_push($this->openAPINullablesSetToNull, 'min_available_local_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('min_available_local_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['min_available_local_date'] = $min_available_local_date;

        return $this;
    }

    /**
     * Gets max_available_local_date
     *
     * @return \DateTime|null
     * @deprecated
     */
    public function getMaxAvailableLocalDate()
    {
        return $this->container['max_available_local_date'];
    }

    /**
     * Sets max_available_local_date
     *
     * @param \DateTime|null $max_available_local_date Date of the most recent flight stored (based on scheduled local times)
     *
     * @return self
     * @deprecated
     */
    public function setMaxAvailableLocalDate($max_available_local_date)
    {
        if (is_null($max_available_local_date)) {
            array_push($this->openAPINullablesSetToNull, 'max_available_local_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_available_local_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['max_available_local_date'] = $max_available_local_date;
