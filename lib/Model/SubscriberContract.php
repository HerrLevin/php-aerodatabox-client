...
/**
 * SubscriberContract Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriberContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriberContract';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Type of subscriber. Completemented by SubscriberId.
     *
     * @return self
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling SubscriberContract., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling SubscriberContract., must be bigger than or equal to 1.');
        }
