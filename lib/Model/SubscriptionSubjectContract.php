...
/**
 * SubscriptionSubjectContract Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionSubjectContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionSubjectContract';
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPI\Client\Model\SubscriptionSubjectType',
        'id' => 'string'
    ];
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\SubscriptionSubjectType
     */
     ...
     * Sets id
     *
     * @param string|null $id Subject ID of a subscription. Complements SubjectType.    E.g. SubjectType = \"FlightNumber\" and SubjectId = \"DL 47\" means that this  subscription is for all updates of flight with number DL47.
     *
     * @return self
     */
