...
/**
 * AirportLocalTimeContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AirportLocalTimeContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirportLocalTimeContract';
    ...
    protected static $openAPITypes = [
        'time' => '\OpenAPI\Client\Model\DateTimeContract',
        'time_zone_id' => 'string'
    ];
    ...
    */
     ...
     * Sets time
     *
     * @param \OpenAPI\Client\Model\DateTimeContract $time Current time at the airport
     *
     * @return self
     */
     ...
     * Sets time_zone_id
     *
     * @param string $time_zone_id Timezone ID of the airport (Olson format)
     *
     * @return self
     */
    public function setTimeZoneId($time_zone_id)
    {
        ...
        if ((mb_strlen($time_zone_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_zone_id when calling AirportLocalTimeContract., must be bigger than or equal to 1.');
        }
