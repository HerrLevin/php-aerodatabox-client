...
/**
 * AirportUrlsContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AirportUrlsContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirportUrlsContract';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('live_atc', $data ?? [], null);
        $this->setIfExists('flight_radar', $data ?? [], null);
    ...
    */
     ...
     * Sets web_site
     *
     * @param string|null $web_site Main web-site of the airport
     *
     * @return self
     */
     ...
     * Sets wikipedia
     *
     * @param string|null $wikipedia Wikipedia page of the airport
     *
     * @return self
     */
     ...
     * Sets twitter
     *
     * @param string|null $twitter Twitter feed of the airport
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getLiveAtc()
    {
        return $this->container['live_atc'];
    }

    /**
     * Sets live_atc
     *
     * @param string|null $live_atc LiveAtc page of the airport
     *
     * @return self
     */
    public function setLiveAtc($live_atc)
    {
        if (is_null($live_atc)) {
            array_push($this->openAPINullablesSetToNull, 'live_atc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('live_atc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['live_atc'] = $live_atc;
     ...
     * @return string|null
     */
    public function getFlightRadar()
    {
        return $this->container['flight_radar'];
    }

    /**
     * Sets flight_radar
     *
     * @param string|null $flight_radar FlightRadar page of the airport
     *
     * @return self
     */
    public function setFlightRadar($flight_radar)
    {
        if (is_null($flight_radar)) {
            array_push($this->openAPINullablesSetToNull, 'flight_radar');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('flight_radar', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['flight_radar'] = $flight_radar;
     ...
     * Sets google_maps
     *
     * @param string|null $google_maps Google Maps URL of the airport
     *
     * @return self
     */
