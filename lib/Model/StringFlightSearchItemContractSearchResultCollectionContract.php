...
/**
 * StringFlightSearchItemContractSearchResultCollectionContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StringFlightSearchItemContractSearchResultCollectionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringFlightSearchItemContractSearchResultCollectionContract';
    ...
    protected static $openAPITypes = [
        'search_by' => 'string',
        'count' => 'int',
        'items' => '\OpenAPI\Client\Model\FlightSearchItemContract[]'
    ];
    ...
    */
    ...
    public function setSearchBy($search_by)
    {
        ...
        if ((mb_strlen($search_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $search_by when calling StringFlightSearchItemContractSearchResultCollectionContract., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringFlightSearchItemContractSearchResultCollectionContract., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringFlightSearchItemContractSearchResultCollectionContract., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\FlightSearchItemContract[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\FlightSearchItemContract[] $items The collection of items
     *
     * @return self
     */
