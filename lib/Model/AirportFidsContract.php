...
/**
 * AirportFidsContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AirportFidsContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirportFidsContract';
    ...
    protected static $openAPITypes = [
        'departures' => '\OpenAPI\Client\Model\AirportFlightContract[]',
        'arrivals' => '\OpenAPI\Client\Model\AirportFlightContract[]'
    ];
    ...
    {
        $this->setIfExists('departures', $data ?? [], null);
        $this->setIfExists('arrivals', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets departures
     *
     * @return \OpenAPI\Client\Model\AirportFlightContract[]|null
     */
     ...
     * Sets departures
     *
     * @param \OpenAPI\Client\Model\AirportFlightContract[]|null $departures Departing flights
     *
     * @return self
     */
    public function setDepartures($departures)
    {
        if (is_null($departures)) {
            array_push($this->openAPINullablesSetToNull, 'departures');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('departures', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets arrivals
     *
     * @param \OpenAPI\Client\Model\AirportFlightContract[]|null $arrivals Arriving flights
     *
     * @return self
     */
    ...
    {
        if (is_null($arrivals)) {
            array_push($this->openAPINullablesSetToNull, 'arrivals');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('arrivals', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
