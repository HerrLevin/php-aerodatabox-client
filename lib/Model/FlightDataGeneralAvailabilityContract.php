...
/**
 * FlightDataGeneralAvailabilityContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FlightDataGeneralAvailabilityContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightDataGeneralAvailabilityContract';
    ...
    */
     ...
     *
     * @param \DateTime|null $min_available_local_date Date of the oldest flight stored (based on scheduled local times)  If not specified, no flight data available
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $max_available_local_date Date of the most recent flight stored (based on scheduled local times)  If not specified, no flight data available
     *
     * @return self
     */
