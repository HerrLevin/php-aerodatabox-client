...
/**
 * DailyRouteStatRecordContract Class Doc Comment
 *
 * @category Class
 ...
 */
class DailyRouteStatRecordContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DailyRouteStatRecordContract';
    ...
    protected static $openAPITypes = [
        'destination' => '\OpenAPI\Client\Model\ListingAirportContract',
        'average_daily_flights' => 'float',
        'operators' => '\OpenAPI\Client\Model\FlightAirlineContract[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'average_daily_flights' => 'averageDailyFlights',
        'operators' => 'operators'
    ];
    ...
    protected static $setters = [
        ...
        'average_daily_flights' => 'setAverageDailyFlights',
    ...
    protected static $getters = [
        ...
        'average_daily_flights' => 'getAverageDailyFlights',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('average_daily_flights', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['average_daily_flights'] === null) {
            $invalidProperties[] = "'average_daily_flights' can't be null";
        }
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\ListingAirportContract $destination Destination airport information
     *
     * @return self
     */
    ...
    /**
     * Gets average_daily_flights
     *
     * @return float
     */
    public function getAverageDailyFlights()
    {
        return $this->container['average_daily_flights'];
    }

    /**
     * Sets average_daily_flights
     *
     * @param float $average_daily_flights Daily average of flights per destination
     *
     * @return self
     */
    public function setAverageDailyFlights($average_daily_flights)
    {
        if (is_null($average_daily_flights)) {
            throw new \InvalidArgumentException('non-nullable average_daily_flights cannot be null');
        }
        $this->container['average_daily_flights'] = $average_daily_flights;
     ...
     * Gets operators
     *
     * @return \OpenAPI\Client\Model\FlightAirlineContract[]
     */
     ...
     * Sets operators
     *
     * @param \OpenAPI\Client\Model\FlightAirlineContract[] $operators Airlines operating on the route
     *
     * @return self
     */
