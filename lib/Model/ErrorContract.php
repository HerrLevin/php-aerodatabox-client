...
/**
 * ErrorContract Class Doc Comment
 *
 * @category Class
 ...
 */
class ErrorContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorContract';
    ...
    */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ErrorContract., must be bigger than or equal to 1.');
        }
