...
/**
 * FlightLegDelayContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FlightLegDelayContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightLegDelayContract';
    ...
    protected static $openAPITypes = [
        'number' => 'string',
        'origins' => '\OpenAPI\Client\Model\FlightDelayContract[]',
        'destinations' => '\OpenAPI\Client\Model\FlightDelayContract[]'
    ];
    ...
    */
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling FlightLegDelayContract., must be bigger than or equal to 1.');
        }
     ...
     * Gets origins
     *
     * @return \OpenAPI\Client\Model\FlightDelayContract[]|null
     */
     ...
     * Sets origins
     *
     * @param \OpenAPI\Client\Model\FlightDelayContract[]|null $origins Delay statistics of flight on departure at origins
     *
     * @return self
     */
    ...
    {
        if (is_null($origins)) {
            array_push($this->openAPINullablesSetToNull, 'origins');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('origins', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets destinations
     *
     * @param \OpenAPI\Client\Model\FlightDelayContract[]|null $destinations Delay statistics of flight on arrival at destinations
     *
     * @return self
     */
