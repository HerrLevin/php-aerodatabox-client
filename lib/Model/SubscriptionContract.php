...
/**
 * SubscriptionContract Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionContract';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'is_active' => 'bool',
        'activate_before_utc' => '\DateTime',
        'expires_on_utc' => '\DateTime',
        'created_on_utc' => '\DateTime',
        'subject' => '\OpenAPI\Client\Model\SubscriptionSubjectContract',
        'subscriber' => '\OpenAPI\Client\Model\SubscriberContract'
    ];
    ...
    protected static $openAPIFormats = [
        'id' => 'uuid',
        'is_active' => null,
        'activate_before_utc' => 'date-time',
        'expires_on_utc' => 'date-time',
    ...
    protected static array $openAPINullables = [
        'id' => false,
        'is_active' => false,
        'activate_before_utc' => true,
        'expires_on_utc' => true,
        'created_on_utc' => false,
        'subject' => false,
        'subscriber' => false
    ];
    ...
    protected static $attributeMap = [
        'id' => 'id',
        'is_active' => 'isActive',
        'activate_before_utc' => 'activateBeforeUtc',
    ...
    protected static $setters = [
        ...
        'activate_before_utc' => 'setActivateBeforeUtc',
        'expires_on_utc' => 'setExpiresOnUtc',
    ...
    protected static $getters = [
        ...
        'activate_before_utc' => 'getActivateBeforeUtc',
        'expires_on_utc' => 'getExpiresOnUtc',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('activate_before_utc', $data ?? [], null);
        $this->setIfExists('expires_on_utc', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['created_on_utc'] === null) {
            $invalidProperties[] = "'created_on_utc' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Identifier of a subscription.   Use this ID to control the subscription in future (e.g. update or delete).
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool $is_active Specifies if the subscription is active
     *
     * @return self
     */
    ...
    /**
     * Gets activate_before_utc
     *
     * @return \DateTime|null
     */
    public function getActivateBeforeUtc()
    {
        return $this->container['activate_before_utc'];
    }

    /**
     * Sets activate_before_utc
     *
     * @param \DateTime|null $activate_before_utc Time (UTC) before which subscription must be activated (may be applicable to   some non-active newly created subscriptions)
     *
     * @return self
     */
    public function setActivateBeforeUtc($activate_before_utc)
    {
        if (is_null($activate_before_utc)) {
            array_push($this->openAPINullablesSetToNull, 'activate_before_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('activate_before_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['activate_before_utc'] = $activate_before_utc;
     ...
     * @return \DateTime|null
     */
    public function getExpiresOnUtc()
    {
        return $this->container['expires_on_utc'];
    }

    /**
     * Sets expires_on_utc
     *
     * @param \DateTime|null $expires_on_utc Time (UTC) when subscription expires and will be removed.    If not specified, subscription never expires.
     *
     * @return self
     */
    public function setExpiresOnUtc($expires_on_utc)
    {
        if (is_null($expires_on_utc)) {
            array_push($this->openAPINullablesSetToNull, 'expires_on_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expires_on_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['expires_on_utc'] = $expires_on_utc;
     ...
     * Sets created_on_utc
     *
     * @param \DateTime $created_on_utc Time (UTC) when subscription was created
     *
     * @return self
     */
    public function setCreatedOnUtc($created_on_utc)
    {
        if (is_null($created_on_utc)) {
            throw new \InvalidArgumentException('non-nullable created_on_utc cannot be null');
        }
     ...
     * Gets subject
     *
     * @return \OpenAPI\Client\Model\SubscriptionSubjectContract
     */
     ...
     * Sets subject
     *
     * @param \OpenAPI\Client\Model\SubscriptionSubjectContract $subject Subscription subject (e.g. flight: such subscription will notify  its consumer about flight updates).
     *
     * @return self
     */
     ...
     * Gets subscriber
     *
     * @return \OpenAPI\Client\Model\SubscriberContract
     */
     ...
     * Sets subscriber
     *
     * @param \OpenAPI\Client\Model\SubscriberContract $subscriber Subscription consumer: where notifications will be sent   (e.g. web-hook with a URL)
     *
     * @return self
     */
