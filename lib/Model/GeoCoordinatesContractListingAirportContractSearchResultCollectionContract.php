...
/**
 * GeoCoordinatesContractListingAirportContractSearchResultCollectionContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeoCoordinatesContractListingAirportContractSearchResultCollectionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeoCoordinatesContractListingAirportContractSearchResultCollectionContract';
    ...
    protected static $openAPITypes = [
        'search_by' => '\OpenAPI\Client\Model\GeoCoordinatesContract',
        'count' => 'int',
    ...
    */
     ...
     * Sets search_by
     *
     * @param \OpenAPI\Client\Model\GeoCoordinatesContract $search_by Search parameter used to find the result.   Please note, it may be different from the actual input provided!
     *
     * @return self
     */
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GeoCoordinatesContractListingAirportContractSearchResultCollectionContract., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GeoCoordinatesContractListingAirportContractSearchResultCollectionContract., must be bigger than or equal to 0.');
        }
