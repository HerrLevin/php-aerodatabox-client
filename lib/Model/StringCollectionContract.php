...
/**
 * StringCollectionContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StringCollectionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringCollectionContract';
    ...
    */
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringCollectionContract., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringCollectionContract., must be bigger than or equal to 0.');
        }
