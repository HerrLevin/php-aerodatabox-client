...
/**
 * ResourceContract Class Doc Comment
 *
 * @category Class
 ...
 */
class ResourceContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceContract';
    ...
    protected static $openAPITypes = [
        ...
        'title' => 'string',
        'description' => 'string',
        'license' => '\OpenAPI\Client\Model\LicenseType',
    ...
    protected static $setters = [
        ...
        'license' => 'setLicense',
        'html_attributions' => 'setHtmlAttributions'
    ];
    ...
    protected static $getters = [
        ...
        'license' => 'getLicense',
        'html_attributions' => 'getHtmlAttributions'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('html_attributions', $data ?? [], null);
    }
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ResourceContract., must be bigger than or equal to 1.');
        }
     ...
     * Sets web_url
     *
     * @param string|null $web_url URL of web-page containing the resource
     *
     * @return self
     */
     ...
     * Sets author
     *
     * @param string|null $author Author name of the resource
     *
     * @return self
     */
    ...
    /**
     * Gets html_attributions
     *
     * @return string[]|null
     */
    public function getHtmlAttributions()
    {
        return $this->container['html_attributions'];
    }

    /**
     * Sets html_attributions
     *
     * @param string[]|null $html_attributions Attributions maintaining copyright, ownership and other legal information adjusted for displaying  as HTML. Each element represent one line.
     *
     * @return self
     */
    public function setHtmlAttributions($html_attributions)
    {
        if (is_null($html_attributions)) {
            array_push($this->openAPINullablesSetToNull, 'html_attributions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('html_attributions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['html_attributions'] = $html_attributions;
