 ...
 */
class Speed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Speed';
    ...
    protected static $setters = [
        'kt' => 'setKt',
        'km_per_hour' => 'setKmPerHour',
        'mi_per_hour' => 'setMiPerHour',
        'meter_per_second' => 'setMeterPerSecond'
    ];
    ...
    protected static $getters = [
        'kt' => 'getKt',
        'km_per_hour' => 'getKmPerHour',
        'mi_per_hour' => 'getMiPerHour',
        'meter_per_second' => 'getMeterPerSecond'
    ];
    ...
    {
        $this->setIfExists('kt', $data ?? [], null);
        $this->setIfExists('km_per_hour', $data ?? [], null);
        $this->setIfExists('mi_per_hour', $data ?? [], null);
        $this->setIfExists('meter_per_second', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['kt'] === null) {
            $invalidProperties[] = "'kt' can't be null";
        }
        if ($this->container['km_per_hour'] === null) {
            $invalidProperties[] = "'km_per_hour' can't be null";
        }
        if ($this->container['mi_per_hour'] === null) {
            $invalidProperties[] = "'mi_per_hour' can't be null";
        }
        if ($this->container['meter_per_second'] === null) {
            $invalidProperties[] = "'meter_per_second' can't be null";
        }
    ...
    {
        return $this->container['kt'];
    }

    /**
     * Sets kt
     *
     * @param float $kt Speed in knots
     *
     * @return self
     */
    ...
    {
        if (is_null($kt)) {
            throw new \InvalidArgumentException('non-nullable kt cannot be null');
        }
        $this->container['kt'] = $kt;
     ...
     * @return float
     */
    public function getKmPerHour()
    {
        return $this->container['km_per_hour'];
    }

    /**
     * Sets km_per_hour
     *
     * @param float $km_per_hour Speed in km per hour
     *
     * @return self
     */
    public function setKmPerHour($km_per_hour)
    {
        if (is_null($km_per_hour)) {
            throw new \InvalidArgumentException('non-nullable km_per_hour cannot be null');
        }
        $this->container['km_per_hour'] = $km_per_hour;
     ...
     * @return float
     */
    public function getMiPerHour()
    {
        return $this->container['mi_per_hour'];
    }

    /**
     * Sets mi_per_hour
     *
     * @param float $mi_per_hour Speed in miles per hour
     *
     * @return self
     */
    public function setMiPerHour($mi_per_hour)
    {
        if (is_null($mi_per_hour)) {
            throw new \InvalidArgumentException('non-nullable mi_per_hour cannot be null');
        }
        $this->container['mi_per_hour'] = $mi_per_hour;

        return $this;
    }

    /**
     * Gets meter_per_second
     *
     * @return float
     */
    public function getMeterPerSecond()
    {
        return $this->container['meter_per_second'];
    }

    /**
     * Sets meter_per_second
     *
     * @param float $meter_per_second Speed in meters per second
     *
     * @return self
     */
    public function setMeterPerSecond($meter_per_second)
    {
        if (is_null($meter_per_second)) {
            throw new \InvalidArgumentException('non-nullable meter_per_second cannot be null');
        }
        $this->container['meter_per_second'] = $meter_per_second;
