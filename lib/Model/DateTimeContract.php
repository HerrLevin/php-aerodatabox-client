...
/**
 * DateTimeContract Class Doc Comment
 *
 * @category Class
 ...
 */
class DateTimeContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DateTimeContract';
    ...
    */
     ...
     * Sets local
     *
     * @param \DateTime $local Local time
     *
     * @return self
     */
