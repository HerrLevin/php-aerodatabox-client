 ...
 */
class Temperature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Temperature';
    ...
    */
     ...
     * Sets c
     *
     * @param float $c Temperature in degrees Celcius
     *
     * @return self
     */
     ...
     * Sets f
     *
     * @param float $f Distance in degrees Fahrenheit
     *
     * @return self
     */
     ...
     * Sets k
     *
     * @param float $k Temperature in degrees Kelvin
     *
     * @return self
     */
