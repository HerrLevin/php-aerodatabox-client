 ...
 */
class Angle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['deg'] > 180)) {
            $invalidProperties[] = "invalid value for 'deg', must be smaller than or equal to 180.";
        }

        if (($this->container['deg'] < -180)) {
            $invalidProperties[] = "invalid value for 'deg', must be bigger than or equal to -180.";
        }

        if ($this->container['rad'] === null) {
            $invalidProperties[] = "'rad' can't be null";
        }
        if (($this->container['rad'] > 3.141592653589793)) {
            $invalidProperties[] = "invalid value for 'rad', must be smaller than or equal to 3.141592653589793.";
        }

        if (($this->container['rad'] < -3.141592653589793)) {
            $invalidProperties[] = "invalid value for 'rad', must be bigger than or equal to -3.141592653589793.";
        }
     ...
     * Sets deg
     *
     * @param float $deg Angle in degrees (between `-180` and `180`)
     *
     * @return self
     */
    public function setDeg($deg)
    {
        ...
        if (($deg > 180)) {
            throw new \InvalidArgumentException('invalid value for $deg when calling Angle., must be smaller than or equal to 180.');
        }
        if (($deg < -180)) {
            throw new \InvalidArgumentException('invalid value for $deg when calling Angle., must be bigger than or equal to -180.');
        }
     ...
     * Sets rad
     *
     * @param float $rad Angle in radians (between `-Pi` and `Pi`)
     *
     * @return self
     */
    public function setRad($rad)
    {
        ...
        if (($rad > 3.141592653589793)) {
            throw new \InvalidArgumentException('invalid value for $rad when calling Angle., must be smaller than or equal to 3.141592653589793.');
        }
        if (($rad < -3.141592653589793)) {
            throw new \InvalidArgumentException('invalid value for $rad when calling Angle., must be bigger than or equal to -3.141592653589793.');
        }
