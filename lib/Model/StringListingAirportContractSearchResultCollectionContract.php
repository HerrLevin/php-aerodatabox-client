...
/**
 * StringListingAirportContractSearchResultCollectionContract Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StringListingAirportContractSearchResultCollectionContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringListingAirportContractSearchResultCollectionContract';
    ...
    protected static $openAPITypes = [
        'search_by' => 'string',
        'count' => 'int',
        'items' => '\OpenAPI\Client\Model\ListingAirportContract[]'
    ];
    ...
    {
        $this->setIfExists('search_by', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['search_by']) < 1)) {
            $invalidProperties[] = "invalid value for 'search_by', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets search_by
     *
     * @param string $search_by Search parameter used to find the result.   Please note, it may be different from the actual input provided!
     *
     * @return self
     */
    public function setSearchBy($search_by)
    {
        if (is_null($search_by)) {
            throw new \InvalidArgumentException('non-nullable search_by cannot be null');
        }

        if ((mb_strlen($search_by) < 1)) {
            throw new \InvalidArgumentException('invalid length for $search_by when calling StringListingAirportContractSearchResultCollectionContract., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringListingAirportContractSearchResultCollectionContract., must be smaller than or equal to 2147483647.');
        }
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling StringListingAirportContractSearchResultCollectionContract., must be bigger than or equal to 0.');
        }
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\ListingAirportContract[] $items The collection of items
     *
     * @return self
     */
