...
/**
 * PercentileBracketContract Class Doc Comment
 *
 * @category Class
 ...
 */
class PercentileBracketContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PercentileBracketContract';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['percentile'] > 95)) {
            $invalidProperties[] = "invalid value for 'percentile', must be smaller than or equal to 95.";
        }

        if (($this->container['percentile'] < 5)) {
            $invalidProperties[] = "invalid value for 'percentile', must be bigger than or equal to 5.";
        }
     ...
     * Sets percentile
     *
     * @param int $percentile Percentile of the distribution
     *
     * @return self
     */
    public function setPercentile($percentile)
    {
        ...
        if (($percentile > 95)) {
            throw new \InvalidArgumentException('invalid value for $percentile when calling PercentileBracketContract., must be smaller than or equal to 95.');
        }
        if (($percentile < 5)) {
            throw new \InvalidArgumentException('invalid value for $percentile when calling PercentileBracketContract., must be bigger than or equal to 5.');
        }
     ...
     * Sets delay
     *
     * @param string $delay Delay of the flight for the specific percentile (format: [-]hh:mm:ss).
     *
     * @return self
     */
