...
/**
 * AircraftRegistrationContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AircraftRegistrationContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AircraftRegistrationContract';
    ...
    */
    ...
    public function setReg($reg)
    {
        ...
        if ((mb_strlen($reg) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reg when calling AircraftRegistrationContract., must be bigger than or equal to 1.');
        }
