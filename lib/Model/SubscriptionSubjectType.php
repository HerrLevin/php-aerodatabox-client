...
/**
 * SubscriptionSubjectType Class Doc Comment
 *
 * @category Class
...
class SubscriptionSubjectType
{
     ...
     */
    public const FLIGHT_BY_NUMBER = 'FlightByNumber';

    public const FLIGHT_BY_AIRPORT_ICAO = 'FlightByAirportIcao';
    ...
    {
        return [
            self::FLIGHT_BY_NUMBER,
            self::FLIGHT_BY_AIRPORT_ICAO
        ];
    }
}
