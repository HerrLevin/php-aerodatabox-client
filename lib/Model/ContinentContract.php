...
/**
 * ContinentContract Class Doc Comment
 *
 * @category Class
 ...
 */
class ContinentContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContinentContract';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ContinentContract., must be bigger than or equal to 1.');
        }
