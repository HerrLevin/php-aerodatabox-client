...
/**
 * CountryContract Class Doc Comment
 *
 * @category Class
 ...
 */
class CountryContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountryContract';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CountryContract., must be bigger than or equal to 1.');
        }
