...
class Distance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mile', $data ?? [], null);
        $this->setIfExists('nm', $data ?? [], null);
        $this->setIfExists('feet', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mile'] === null) {
            $invalidProperties[] = "'mile' can't be null";
        }
        if ($this->container['nm'] === null) {
            $invalidProperties[] = "'nm' can't be null";
        }
        if ($this->container['feet'] === null) {
            $invalidProperties[] = "'feet' can't be null";
        }
     ...
     * Sets meter
     *
     * @param float $meter Distance in meters
     *
     * @return self
     */
     ...
     * Sets mile
     *
     * @param float $mile Distance in statute miles
     *
     * @return self
     */
    ...
    {
        if (is_null($mile)) {
            throw new \InvalidArgumentException('non-nullable mile cannot be null');
        }
    ...
    {
        return $this->container['feet'];
    }

    /**
     * Sets feet
     *
     * @param float $feet Distance in feet
     *
     * @return self
     */
    ...
    {
        if (is_null($feet)) {
            throw new \InvalidArgumentException('non-nullable feet cannot be null');
        }
        $this->container['feet'] = $feet;
