...
/**
 * AirportFlightContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AirportFlightContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirportFlightContract';
    ...
    protected static $openAPITypes = [
        'movement' => '\OpenAPI\Client\Model\FlightAirportMovementContract',
    ...
    {
        $this->setIfExists('movement', $data ?? [], null);
    ...
    */
     ...
     * Gets movement
     *
     * @return \OpenAPI\Client\Model\FlightAirportMovementContract|null
     * @deprecated
     */
    ...
    {
        if (is_null($movement)) {
            array_push($this->openAPINullablesSetToNull, 'movement');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('movement', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets departure
     *
     * @param \OpenAPI\Client\Model\FlightAirportMovementContract|null $departure Only set if Movement is not set.    Flight information relevant to airport of origin.   Airport sub-property stands for airport of origin as well unless it's equal to current requested  airport. Otherwise, not set.
     *
     * @return self
     */
    public function setDeparture($departure)
    {
        if (is_null($departure)) {
            array_push($this->openAPINullablesSetToNull, 'departure');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('departure', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets arrival
     *
     * @param \OpenAPI\Client\Model\FlightAirportMovementContract|null $arrival Only set if Movement is not set.    Flight information relevant to airport of destination.   Airport sub-property stands for airport of destination as well unless it's equal to current requested  airport. Otherwise, not set.
     *
     * @return self
     */
    ...
    {
        if (is_null($arrival)) {
            array_push($this->openAPINullablesSetToNull, 'arrival');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('arrival', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling AirportFlightContract., must be bigger than or equal to 1.');
        }
