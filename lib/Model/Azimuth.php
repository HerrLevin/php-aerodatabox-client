 ...
 */
class Azimuth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Azimuth';
    ...
    {
        $this->setIfExists('deg', $data ?? [], null);
        $this->setIfExists('rad', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['deg'] === null) {
            $invalidProperties[] = "'deg' can't be null";
        }
        if (($this->container['deg'] > 360)) {
            $invalidProperties[] = "invalid value for 'deg', must be smaller than or equal to 360.";
        }

        if (($this->container['deg'] < 0)) {
            $invalidProperties[] = "invalid value for 'deg', must be bigger than or equal to 0.";
        }

        if ($this->container['rad'] === null) {
            $invalidProperties[] = "'rad' can't be null";
        }
        if (($this->container['rad'] > 6.283185307179586)) {
            $invalidProperties[] = "invalid value for 'rad', must be smaller than or equal to 6.283185307179586.";
        }

        if (($this->container['rad'] < 0)) {
            $invalidProperties[] = "invalid value for 'rad', must be bigger than or equal to 0.";
        }
     ...
     * Sets deg
     *
     * @param float $deg Angle in degrees (between `0` and `360`)
     *
     * @return self
     */
    ...
    {
        if (is_null($deg)) {
            throw new \InvalidArgumentException('non-nullable deg cannot be null');
        }

        if (($deg > 360)) {
            throw new \InvalidArgumentException('invalid value for $deg when calling Azimuth., must be smaller than or equal to 360.');
        }
        if (($deg < 0)) {
            throw new \InvalidArgumentException('invalid value for $deg when calling Azimuth., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['rad'];
    }

    /**
     * Sets rad
     *
     * @param float $rad Angle in radians (`0` and `2 * Pi`)
     *
     * @return self
     */
    ...
    {
        if (is_null($rad)) {
            throw new \InvalidArgumentException('non-nullable rad cannot be null');
        }

        if (($rad > 6.283185307179586)) {
            throw new \InvalidArgumentException('invalid value for $rad when calling Azimuth., must be smaller than or equal to 6.283185307179586.');
        }
        if (($rad < 0)) {
            throw new \InvalidArgumentException('invalid value for $rad when calling Azimuth., must be bigger than or equal to 0.');
        }

        $this->container['rad'] = $rad;
