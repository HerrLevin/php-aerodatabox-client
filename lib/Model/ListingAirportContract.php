...
/**
 * ListingAirportContract Class Doc Comment
 *
 * @category Class
 ...
 */
class ListingAirportContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListingAirportContract';
    ...
    */
     ...
     * Sets local_code
     *
     * @param string|null $local_code Code of the airport within the local or national codification system
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ListingAirportContract., must be bigger than or equal to 1.');
        }
     ...
     * Gets location
     *
     * @return \OpenAPI\Client\Model\GeoCoordinatesContract|null
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\GeoCoordinatesContract|null $location Location of the airport
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code Two-letter country code of the airport
     *
     * @return self
     */
     ...
     * Sets time_zone
     *
     * @param string|null $time_zone Time zone of the airport in Olson format (e.g. \"Europe/Amsterdam\")
     *
     * @return self
     */
