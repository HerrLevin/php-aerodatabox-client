...
/**
 * FlightNotificationItemContract Class Doc Comment
 *
 * @category Class
 ...
 */
class FlightNotificationItemContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlightNotificationItemContract';
    ...
    protected static $attributeMap = [
        ...
        'notification_remark' => 'notificationRemark',
    ...
    protected static $setters = [
        'notification_summary' => 'setNotificationSummary',
        'notification_remark' => 'setNotificationRemark',
    ...
    protected static $getters = [
        'notification_summary' => 'getNotificationSummary',
        'notification_remark' => 'getNotificationRemark',
    ...
    {
        $this->setIfExists('notification_summary', $data ?? [], null);
        $this->setIfExists('notification_remark', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets notification_summary
     *
     * @return string|null
     */
    public function getNotificationSummary()
    {
        return $this->container['notification_summary'];
    }

    /**
     * Sets notification_summary
     *
     * @param string|null $notification_summary Human-readable summary of the flight status update
     *
     * @return self
     */
    public function setNotificationSummary($notification_summary)
    {
        if (is_null($notification_summary)) {
            array_push($this->openAPINullablesSetToNull, 'notification_summary');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('notification_summary', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['notification_summary'] = $notification_summary;

        return $this;
    }

    /**
     * Gets notification_remark
     *
     * @return string|null
     */
    public function getNotificationRemark()
    {
        return $this->container['notification_remark'];
    }

    /**
     * Sets notification_remark
     *
     * @param string|null $notification_remark Human-readable remark to the flight status update
     *
     * @return self
     */
    public function setNotificationRemark($notification_remark)
    {
        if (is_null($notification_remark)) {
            array_push($this->openAPINullablesSetToNull, 'notification_remark');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('notification_remark', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['notification_remark'] = $notification_remark;
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling FlightNotificationItemContract., must be bigger than or equal to 1.');
        }
