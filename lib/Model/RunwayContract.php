...
/**
 * RunwayContract Class Doc Comment
 *
 * @category Class
 ...
 */
class RunwayContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RunwayContract';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'true_hdg' => 'float',
        'length' => '\OpenAPI\Client\Model\Distance',
        'width' => '\OpenAPI\Client\Model\Distance',
        'is_closed' => 'bool',
        'location' => '\OpenAPI\Client\Model\GeoCoordinatesContract',
        'surface' => '\OpenAPI\Client\Model\SurfaceType',
        'displaced_threshold' => '\OpenAPI\Client\Model\Distance',
        'has_lighting' => 'bool'
    ];
    ...
    protected static $attributeMap = [
        ...
        'location' => 'location',
        'surface' => 'surface',
        'displaced_threshold' => 'displacedThreshold',
    ...
    protected static $setters = [
        ...
        'surface' => 'setSurface',
        'displaced_threshold' => 'setDisplacedThreshold',
        'has_lighting' => 'setHasLighting'
    ];
    ...
    protected static $getters = [
        ...
        'surface' => 'getSurface',
        'displaced_threshold' => 'getDisplacedThreshold',
        'has_lighting' => 'getHasLighting'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('true_hdg', $data ?? [], null);
        $this->setIfExists('length', $data ?? [], null);
        $this->setIfExists('width', $data ?? [], null);
        $this->setIfExists('is_closed', $data ?? [], null);
        $this->setIfExists('location', $data ?? [], null);
        $this->setIfExists('surface', $data ?? [], null);
        $this->setIfExists('displaced_threshold', $data ?? [], null);
        $this->setIfExists('has_lighting', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['true_hdg'] === null) {
            $invalidProperties[] = "'true_hdg' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Name of the runway. E.g.: 27L, 06, 36C, etc.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RunwayContract., must be bigger than or equal to 1.');
        }
     ...
     * @return float
     */
    public function getTrueHdg()
    {
        return $this->container['true_hdg'];
    }

    /**
     * Sets true_hdg
     *
     * @param float $true_hdg True heading of the runway in degrees
     *
     * @return self
     */
    public function setTrueHdg($true_hdg)
    {
        if (is_null($true_hdg)) {
            throw new \InvalidArgumentException('non-nullable true_hdg cannot be null');
        }
        $this->container['true_hdg'] = $true_hdg;
     ...
     * Sets length
     *
     * @param \OpenAPI\Client\Model\Distance|null $length Length of the runway
     *
     * @return self
     */
     ...
     * Sets width
     *
     * @param \OpenAPI\Client\Model\Distance|null $width Width of the runway
     *
     * @return self
     */
     ...
     * Sets is_closed
     *
     * @param bool $is_closed Marker, if runway is closed
     *
     * @return self
     */
     ...
     * Sets location
     *
     * @param \OpenAPI\Client\Model\GeoCoordinatesContract|null $location Coordinates of intersection of the threshold and centerline
     *
     * @return self
     */
     ...
     * Gets surface
     *
     * @return \OpenAPI\Client\Model\SurfaceType
     */
     ...
     * Sets surface
     *
     * @param \OpenAPI\Client\Model\SurfaceType $surface Type of runway surface<p>Possible values:</p> <ul> <li><b>0 - Unknown</b></li> <li><b>1 - Asphalt</b></li> <li><b>2 - Concrete</b></li> <li><b>3 - Grass</b></li> <li><b>4 - Dirt</b></li> <li><b>5 - Gravel</b></li> <li><b>6 - DryLakebed</b></li> <li><b>7 - Water</b></li> <li><b>8 - Snow</b></li> </ul>
     *
     * @return self
     */
    ...
    /**
     * Gets displaced_threshold
     *
     * @return \OpenAPI\Client\Model\Distance|null
     */
    public function getDisplacedThreshold()
    {
        return $this->container['displaced_threshold'];
    }

    /**
     * Sets displaced_threshold
     *
     * @param \OpenAPI\Client\Model\Distance|null $displaced_threshold The distance to the displaced threshold
     *
     * @return self
     */
    public function setDisplacedThreshold($displaced_threshold)
    {
        if (is_null($displaced_threshold)) {
            array_push($this->openAPINullablesSetToNull, 'displaced_threshold');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('displaced_threshold', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['displaced_threshold'] = $displaced_threshold;
     ...
     * @return bool|null
     */
    public function getHasLighting()
    {
        return $this->container['has_lighting'];
    }

    /**
     * Sets has_lighting
     *
     * @param bool|null $has_lighting Does runway has lights
     *
     * @return self
     */
    public function setHasLighting($has_lighting)
    {
        if (is_null($has_lighting)) {
            array_push($this->openAPINullablesSetToNull, 'has_lighting');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('has_lighting', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['has_lighting'] = $has_lighting;
