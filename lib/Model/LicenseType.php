...
class LicenseType
{
     ...
     */
    public const ALL_RIGHTS_RESERVED = 'AllRightsReserved';

    public const ATTRIBUTION_NONCOMMERCIAL_SHARE_ALIKE_CC = 'AttributionNoncommercialShareAlikeCC';

    public const ATTRIBUTION_NONCOMMERCIAL_CC = 'AttributionNoncommercialCC';

    public const ATTRIBUTION_NONCOMMERCIAL_NO_DERIVATIVES_CC = 'AttributionNoncommercialNoDerivativesCC';

    public const ATTRIBUTION_CC = 'AttributionCC';

    public const ATTRIBUTION_SHARE_ALIKE_CC = 'AttributionShareAlikeCC';

    public const ATTRIBUTION_NO_DERIVATIVES_CC = 'AttributionNoDerivativesCC';

    public const NO_KNOWN_COPYRIGHT_RESTRICTIONS = 'NoKnownCopyrightRestrictions';

    public const UNITED_STATES_GOVERNMENT_WORK = 'UnitedStatesGovernmentWork';

    public const PUBLIC_DOMAIN_DEDICATION_CC0 = 'PublicDomainDedicationCC0';

    public const PUBLIC_DOMAIN_MARK = 'PublicDomainMark';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::ATTRIBUTION_NONCOMMERCIAL_SHARE_ALIKE_CC,
            self::ATTRIBUTION_NONCOMMERCIAL_CC,
            self::ATTRIBUTION_NONCOMMERCIAL_NO_DERIVATIVES_CC,
            self::ATTRIBUTION_CC,
            self::ATTRIBUTION_SHARE_ALIKE_CC,
            self::ATTRIBUTION_NO_DERIVATIVES_CC,
            self::NO_KNOWN_COPYRIGHT_RESTRICTIONS,
            self::UNITED_STATES_GOVERNMENT_WORK,
            self::PUBLIC_DOMAIN_DEDICATION_CC0,
            self::PUBLIC_DOMAIN_MARK
        ];
    }
}
