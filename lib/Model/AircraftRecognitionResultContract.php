...
/**
 * AircraftRecognitionResultContract Class Doc Comment
 *
 * @category Class
 ...
 */
class AircraftRecognitionResultContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AircraftRecognitionResultContract';
    ...
    protected static $openAPITypes = [
        'recognized' => '\OpenAPI\Client\Model\AircraftContract[]'
    ];
    ...
    */
     ...
     * Sets recognized
     *
     * @param \OpenAPI\Client\Model\AircraftContract[] $recognized Collection of aircraft found in database for corresponding registration. If nothing  is found, the collection will be empty.
     *
     * @return self
     */
