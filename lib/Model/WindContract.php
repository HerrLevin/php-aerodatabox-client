...
/**
 * WindContract Class Doc Comment
 *
 * @category Class
 ...
 */
class WindContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WindContract';
    ...
    protected static $openAPITypes = [
        'speed' => '\OpenAPI\Client\Model\Speed',
        'direction' => '\OpenAPI\Client\Model\Azimuth',
        'gusts' => '\OpenAPI\Client\Model\Speed'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('gusts', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets speed
     *
     * @param \OpenAPI\Client\Model\Speed $speed Wind speed
     *
     * @return self
     */
     ...
     * Sets direction
     *
     * @param \OpenAPI\Client\Model\Azimuth $direction Wind direction
     *
     * @return self
     */
     ...
     * Gets gusts
     *
     * @return \OpenAPI\Client\Model\Speed|null
     */
    public function getGusts()
    {
        return $this->container['gusts'];
    }

    /**
     * Sets gusts
     *
     * @param \OpenAPI\Client\Model\Speed|null $gusts Wind gusts
     *
     * @return self
     */
    ...
    {
        if (is_null($gusts)) {
            array_push($this->openAPINullablesSetToNull, 'gusts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('gusts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['gusts'] = $gusts;
