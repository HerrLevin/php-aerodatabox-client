 ...
 */
class Pressure implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pressure';
    ...
    {
        $this->setIfExists('h_pa', $data ?? [], null);
        $this->setIfExists('in_hg', $data ?? [], null);
        $this->setIfExists('mm_hg', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['h_pa'] === null) {
            $invalidProperties[] = "'h_pa' can't be null";
        }
        if ($this->container['in_hg'] === null) {
            $invalidProperties[] = "'in_hg' can't be null";
        }
        if ($this->container['mm_hg'] === null) {
            $invalidProperties[] = "'mm_hg' can't be null";
        }
    ...
    {
        return $this->container['h_pa'];
    }

    /**
     * Sets h_pa
     *
     * @param float $h_pa Pressure in hectopascals
     *
     * @return self
     */
    public function setHPa($h_pa)
    {
        if (is_null($h_pa)) {
            throw new \InvalidArgumentException('non-nullable h_pa cannot be null');
        }
        $this->container['h_pa'] = $h_pa;
     ...
     * @return float
     */
    public function getInHg()
    {
        return $this->container['in_hg'];
    }

    /**
     * Sets in_hg
     *
     * @param float $in_hg Pressure in inches mercury
     *
     * @return self
     */
    public function setInHg($in_hg)
    {
        if (is_null($in_hg)) {
            throw new \InvalidArgumentException('non-nullable in_hg cannot be null');
        }
        $this->container['in_hg'] = $in_hg;
    ...
    {
        return $this->container['mm_hg'];
    }

    /**
     * Sets mm_hg
     *
     * @param float $mm_hg Pressure in millimeters mercury
     *
     * @return self
     */
    public function setMmHg($mm_hg)
    {
        if (is_null($mm_hg)) {
            throw new \InvalidArgumentException('non-nullable mm_hg cannot be null');
        }
        $this->container['mm_hg'] = $mm_hg;
