...
/**
 * FeedServiceEnum Class Doc Comment
 *
 * @category Class
...
class FeedServiceEnum
{
     ...
     */
    public const FLIGHT_SCHEDULES = 'FlightSchedules';

    public const FLIGHT_LIVE_UPDATES = 'FlightLiveUpdates';

    public const ADSB_UPDATES = 'AdsbUpdates';
