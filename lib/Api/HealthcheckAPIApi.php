...
/**
 * HealthcheckAPIApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class HealthcheckAPIApi
{
    ...
    /**
     * Operation getAirportFeedStatus
     *
     * Data feed services status by ICAO code [FREE TIER]
     *
     * @param  string $icao 4-digit ICAO-code of the airport (e.g.: EHAM, KLAX, UUEE, etc.). Full, stripped and any case formats are acceptable. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAirportFeedStatus'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\AirportFeedServiceStatusContract
     */
    public function getAirportFeedStatus($icao, string $contentType = self::contentTypes['getAirportFeedStatus'][0])
    {
        list($response) = $this->getAirportFeedStatusWithHttpInfo($icao, $contentType);
        return $response;
    }

    /**
     * Operation getAirportFeedStatusWithHttpInfo
     *
     * Data feed services status by ICAO code [FREE TIER]
     *
     * @param  string $icao 4-digit ICAO-code of the airport (e.g.: EHAM, KLAX, UUEE, etc.). Full, stripped and any case formats are acceptable. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\AirportFeedServiceStatusContract, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAirportFeedStatusWithHttpInfo($icao, string $contentType = self::contentTypes['getAirportFeedStatus'][0])
    {
        $request = $this->getAirportFeedStatusRequest($icao, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\AirportFeedServiceStatusContract',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation getAirportFeedStatusAsync
     *
     * Data feed services status by ICAO code [FREE TIER]
     *
     * @param  string $icao 4-digit ICAO-code of the airport (e.g.: EHAM, KLAX, UUEE, etc.). Full, stripped and any case formats are acceptable. (required)
     ...
     */
    public function getAirportFeedStatusAsync($icao, string $contentType = self::contentTypes['getAirportFeedStatus'][0])
    {
        return $this->getAirportFeedStatusAsyncWithHttpInfo($icao, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAirportFeedStatusAsyncWithHttpInfo
     *
     * Data feed services status by ICAO code [FREE TIER]
     *
     * @param  string $icao 4-digit ICAO-code of the airport (e.g.: EHAM, KLAX, UUEE, etc.). Full, stripped and any case formats are acceptable. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAirportFeedStatusAsyncWithHttpInfo($icao, string $contentType = self::contentTypes['getAirportFeedStatus'][0])
    {
        $returnType = '\OpenAPI\Client\Model\AirportFeedServiceStatusContract';
        $request = $this->getAirportFeedStatusRequest($icao, $contentType);
    ...
    /**
     * Create request for operation 'getAirportFeedStatus'
     *
     * @param  string $icao 4-digit ICAO-code of the airport (e.g.: EHAM, KLAX, UUEE, etc.). Full, stripped and any case formats are acceptable. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAirportFeedStatus'] to see the possible values for this operation
     *
     ...
     */
    public function getAirportFeedStatusRequest($icao, string $contentType = self::contentTypes['getAirportFeedStatus'][0])
    {

        // verify the required parameter 'icao' is set
        if ($icao === null || (is_array($icao) && count($icao) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $icao when calling getAirportFeedStatus'
            );
        }
        if (strlen($icao) > 4) {
            throw new \InvalidArgumentException('invalid length for "$icao" when calling HealthcheckAPIApi.getAirportFeedStatus, must be smaller than or equal to 4.');
        }
        if (strlen($icao) < 4) {
            throw new \InvalidArgumentException('invalid length for "$icao" when calling HealthcheckAPIApi.getAirportFeedStatus, must be bigger than or equal to 4.');
        }
        

        $resourcePath = '/health/services/airports/{icao}/feeds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($icao !== null) {
            $resourcePath = str_replace(
                '{' . 'icao' . '}',
                ObjectSerializer::toPathValue($icao),
                $resourcePath
            );
        }
    ...
    /**
     * Operation getFeedAirports
     *
     * Airports supporting data feed service [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Airport data feed service name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeedAirports'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\StringCollectionContract
     */
    public function getFeedAirports($service, string $contentType = self::contentTypes['getFeedAirports'][0])
    {
        list($response) = $this->getFeedAirportsWithHttpInfo($service, $contentType);
        return $response;
    }

    /**
     * Operation getFeedAirportsWithHttpInfo
     *
     * Airports supporting data feed service [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Airport data feed service name (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\StringCollectionContract, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeedAirportsWithHttpInfo($service, string $contentType = self::contentTypes['getFeedAirports'][0])
    {
        $request = $this->getFeedAirportsRequest($service, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\StringCollectionContract',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation getFeedAirportsAsync
     *
     * Airports supporting data feed service [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Airport data feed service name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedAirportsAsync($service, string $contentType = self::contentTypes['getFeedAirports'][0])
    {
        return $this->getFeedAirportsAsyncWithHttpInfo($service, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeedAirportsAsyncWithHttpInfo
     *
     * Airports supporting data feed service [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Airport data feed service name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedAirportsAsyncWithHttpInfo($service, string $contentType = self::contentTypes['getFeedAirports'][0])
    {
        $returnType = '\OpenAPI\Client\Model\StringCollectionContract';
        $request = $this->getFeedAirportsRequest($service, $contentType);
    ...
    /**
     * Create request for operation 'getFeedAirports'
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Airport data feed service name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeedAirports'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeedAirportsRequest($service, string $contentType = self::contentTypes['getFeedAirports'][0])
    {

        // verify the required parameter 'service' is set
        if ($service === null || (is_array($service) && count($service) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $service when calling getFeedAirports'
            );
        }


        $resourcePath = '/health/services/feeds/{service}/airports';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getFeedServiceStatus
     *
     * General status of data feed services [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Data feed service name (required)
     * @param  bool|null $with_http_code If true, reflect status of the service in the HTTP code of the response (if the service is down, HTTP code will be 503). (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeedServiceStatus'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\FeedServiceStatusContract|\OpenAPI\Client\Model\FeedServiceStatusContract
     */
    public function getFeedServiceStatus($service, $with_http_code = false, string $contentType = self::contentTypes['getFeedServiceStatus'][0])
    {
        list($response) = $this->getFeedServiceStatusWithHttpInfo($service, $with_http_code, $contentType);
        return $response;
    }

    /**
     * Operation getFeedServiceStatusWithHttpInfo
     *
     * General status of data feed services [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Data feed service name (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of |\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\ErrorContract|\OpenAPI\Client\Model\FeedServiceStatusContract|\OpenAPI\Client\Model\FeedServiceStatusContract, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFeedServiceStatusWithHttpInfo($service, $with_http_code = false, string $contentType = self::contentTypes['getFeedServiceStatus'][0])
    {
        $request = $this->getFeedServiceStatusRequest($service, $with_http_code, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 503:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\FeedServiceStatusContract',
                        $request,
                        $response,
                    );
                case 200:
    ...
    /**
     * Operation getFeedServiceStatusAsync
     *
     * General status of data feed services [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Data feed service name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedServiceStatusAsync($service, $with_http_code = false, string $contentType = self::contentTypes['getFeedServiceStatus'][0])
    {
        return $this->getFeedServiceStatusAsyncWithHttpInfo($service, $with_http_code, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFeedServiceStatusAsyncWithHttpInfo
     *
     * General status of data feed services [FREE TIER]
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Data feed service name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedServiceStatusAsyncWithHttpInfo($service, $with_http_code = false, string $contentType = self::contentTypes['getFeedServiceStatus'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FeedServiceStatusContract';
        $request = $this->getFeedServiceStatusRequest($service, $with_http_code, $contentType);
    ...
    /**
     * Create request for operation 'getFeedServiceStatus'
     *
     * @param  \OpenAPIClientModelFeedServiceEnum $service Data feed service name (required)
     * @param  bool|null $with_http_code If true, reflect status of the service in the HTTP code of the response (if the service is down, HTTP code will be 503). (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getFeedServiceStatus'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFeedServiceStatusRequest($service, $with_http_code = false, string $contentType = self::contentTypes['getFeedServiceStatus'][0])
    {

        // verify the required parameter 'service' is set
        if ($service === null || (is_array($service) && count($service) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $service when calling getFeedServiceStatus'
            );
        }



        $resourcePath = '/health/services/feeds/{service}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
